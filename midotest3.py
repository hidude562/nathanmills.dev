...
midi_dir = "/home/nathan/Documents/binaries/node-vgmusic-downloader-1.0.0/download/console/nintendo/gba/" #@param {type:"string"}
...
baseSongPath = "/home/nathan/Documents/binaries/node-vgmusic-downloader-1.0.0/download/console/nintendo/gba/"
...
for songPath in midi_files:
    ...
    if (fileIndex % 1000 == 0):
        with open("/home/nathan/.config/JetBrains/PyCharmCE2023.3/scratches/dataVG.txt", "w") as dataFile:
            print("WRITING")
            dataFile.write(allData)



with open("dataVG.txt", "w") as dataFile:
    print("WRITING")
    dataFile.write(allData)
